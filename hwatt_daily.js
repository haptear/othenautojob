...
================Loon==============
[Script]
cron "10 9 * * *" script-path=hwatt_daily.js,tag=watt每天领奖
...
function daily () {
  return new Promise(resolve => {
    let req = {
      url: `https://api.watt.beer/check/do`,
      headers: {
        "accept": "application/json, text/plain, */*",
        "accept-language": "zh-CN,zh;q=0.9,en;q=0.8,en-US;q=0.7",
        "authorization": "Bearer E55A0l6aVoCsQP6ZFHX/qqOfHa+TPIAv/9o8MDyeYL17MTJ/cifd99mHgZyPyiwVItuIWaRLMgcULPYO5p/Xcw==",
